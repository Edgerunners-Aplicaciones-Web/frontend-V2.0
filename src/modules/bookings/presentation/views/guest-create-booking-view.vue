...
import { usePropertyStore } from '../../../properties/application/store/property.store.js';
...
onMounted(async () => {
  try {
    ...
    console.error("Error loading bookings details (View):", err);
...
async function handleBooking() {
  ...
  try {
    ...
    console.error("Error creating bookings (View):", err);
